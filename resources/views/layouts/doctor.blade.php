...
<head>
  ...
  <style>
    ...
    .tabs-nav .tab-link:hover { background: #f8f9fa; }
    .tabs-nav .tab-link.active { color: #0d6efd; font-weight: 600; }
  </style>
</head>
...
<body class="bg-light">
  ...
  <!-- Main -->
  <main class="app-main content container-fluid pt-4">
    @yield('content')
